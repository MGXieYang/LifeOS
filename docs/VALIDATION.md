...
- APK V2 打包成功，包名 `com.niuma.driver`，versionCode `2`，versionName `2.0.0`，minSdk 26，targetSdk 35。
- 最终 Debug APK SHA-256：`FF7ABE151294F2055434D13690419E563AD188862D3C43863C7452C6531F4B0A`；APK Signature Scheme v2 校验通过，签名者 1 个。
...
- `req/需求文档V2.0.docx` 已同步运行时联网日历边界与默认工时修正，保留 1051 段结构；默认 09:30—19:00、12:30—14:00 午休、有效 8 小时。
